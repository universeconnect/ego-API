...
$sql = "INSERT INTO softwarecoures (ID,title,classify,link,icon,name,release_time) VALUES (0,'{$_POST['title']}','{$_POST['classify']}','{$_POST['link']}','{$_POST['icon']}','{$_POST['name']}','{$_POST['release_time']}')";
